...
@CustomObservable(
    ...
    [
        ("category", extend_property(
            ...
            examples=["ps_script", "process_creation", "network_connection", "file_event"]
        )),
        ("product", extend_property(
            StringProperty(),
        ...
        ("definition", extend_property(
            ...
            examples=["Windows Security Event Logs for authentication and access events"]
        )),
    ],
