...
example_CryptocurrencyTransactionSCO = CryptocurrencyTransaction(
    ...
    input=[{"address_ref": "cryptocurrency-wallet--b1bc02bd-f10d-40e4-86d1-9e2ef3aa919f", "amount": 0.84}],
    output=[
        {"address_ref": "cryptocurrency-wallet--b6ae6083-875f-5fe9-84b9-89e168f89406", "amount": 0.8},
        {"address_ref": "cryptocurrency-wallet--4d18102a-f35a-4176-9509-f96a3370d067", "amount": 0.04},
    ],
)
